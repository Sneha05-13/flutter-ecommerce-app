      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              // Image
             Lottie.asset(RImages.deliveredEmailIllustration, width: SHelperFunctions.screenWidth() * 0.6,),
              const SizedBox(height: RSizes.spaceBtwSections),
              
              // Title & Subtitle
              Text(RTexts.confirmEmail, style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
              const SizedBox(height: RSizes.spaceBtwItems),
              Text('supportecomm@gmail.com', style: Theme.of(context).textTheme.labelLarge, textAlign: TextAlign.center),
              const SizedBox(height: RSizes.spaceBtwItems),
