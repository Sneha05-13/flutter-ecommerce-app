...
class SubCategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SAppBar(title: Text('Sports shirts'), showBackArrow: true),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              /// Banner
              SRoundedImage(imageUrl: RImages.promoBanner1, applyImageRadius: true, width: double.infinity),
              ...
              Column(
                children: [
                  //---Heading
                  RSectionHeading(title: 'Sports Shoes', onPressed: () {}),
