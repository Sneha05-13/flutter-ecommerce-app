            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const RSettingMenuTile(icon: Iconsax.security_card, title: 'Account Privacy', subTitle: 'Manage data usage and connected accounts'),

                   //---App Settings
                  const SizedBox(height: RSizes.spaceBtwSections),
                  const RSectionHeading(title: 'App Settings', showActionButton: true),
                  const SizedBox(height: RSizes.spaceBtwItems),
                  const RSettingMenuTile(icon: Iconsax.document_upload, title: 'Load data', subTitle: 'Upload Data to your Cloud Firebase'),
                   RSettingMenuTile(
